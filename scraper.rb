...
district_16 = EveryPolitician::Wikidata.wikipedia_xpath( 
  ...
  xpath: '//table[.//th[contains(.,"Representative")]]//tr//td[position() = last() - 3]//a[not(@class="new")]/@title',
)
...
party_list_16 = EveryPolitician::Wikidata.wikipedia_xpath( 
  ...
  xpath: '//table[.//th[contains(.,"Representative")]]//tr//td[position() = last() - 2]//a[not(@class="new")]/@title',
)
